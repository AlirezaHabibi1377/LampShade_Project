...
namespace ServiceHost.Pages
{
    ...
    public class CheckoutModel : PageModel
    {
            ...
            [FromQuery] long oId)
        {
            ...
            var verificationResponse = _zarinPalFactory.CreateVerificationRequest(
                authority, orderAmount.ToString());
            ...
            {
                result = result.Failed("پرداخت با موفقیت انجام نشد در صورت کسر وجه از حساب، مبلغ با 24 ساعت دیگر به حساب شما بازگردانده خواهد شد..");
                return RedirectToPage("/PaymentResult", result);
            }
        } 
    }
